...
verbs.push({
    ...
    future: 'will be',
    group: 'Helping Verbs',
    definition: 'Used to describe the state of something or someone. It\'s different from action verbs as it doesn\'t show action.'
});

stories.push({
    verbId: 'be',
    past: 'Yesterday, I was very tired after school.',
    present: 'Right now, I am being careful with my homework.',
    future: 'Tomorrow, I will be excited for the field trip.'
});
...
verbs.push({
    ...
    present: 'having',
    future: 'will have',
    group: 'Possession and Giving',
    definition: 'Used to show possession or to form perfect tenses. It\'s different from "own" as it can be used for temporary possession.'
});

stories.push({
    verbId: 'have',
    past: 'Last week, I had a cold and stayed home.',
    present: 'I am having a great time at the party now.',
    future: 'Next year, I will have a new teacher.'
});
...
verbs.push({
    ...
    future: 'will do',
    group: 'Basic Actions',
    definition: 'Used to perform an action or as a helping verb in questions and negatives. It\'s more general than specific action verbs.'
});

stories.push({
    verbId: 'do',
    past: 'I did my homework before dinner yesterday.',
    present: 'I am doing my best to learn new things.',
    future: 'I will do better on the next test.'
});
...
verbs.push({
    ...
    future: 'will say',
    group: 'Communication',
    definition: 'Used to express words or opinions. It\'s different from "tell" as it doesn\'t require a direct object.'
});

stories.push({
    verbId: 'say',
    past: 'The teacher said we did a good job.',
    present: 'My mom is saying it\'s time for bed.',
    future: 'I will say "thank you" when I get a gift.'
});
...
verbs.push({
    ...
    future: 'will go',
    group: 'Movement',
    definition: 'Used to move from one place to another. It\'s different from "come" as it indicates movement away from the current location.'
});

stories.push({
    verbId: 'go',
    past: 'We went to the park last Saturday.',
    present: 'I am going to the library now.',
    future: 'They will go on vacation next month.'
});
